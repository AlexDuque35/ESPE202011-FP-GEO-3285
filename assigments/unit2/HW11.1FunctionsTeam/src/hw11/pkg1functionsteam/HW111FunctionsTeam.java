package hw11.pkg1functionsteam;
 ...
 * @author aduqu
 */
public class HW111FunctionsTeam {
        ...
        do {
            ...
            switch (option) {
                ...
                case 1:
                    ...
                    do {
                        option = printHome(input);

                        switch (option) {

                            case 1:
                                do {
                                    option = prinOption1Home(input);

                                    switch (option) {

                                        case 1:
                                            convertGPSCoordenatesToDecimalCoordenates(input);
                                            break;

                                        case 2:
                                            ConvertGPSCoordenatesToDecimalCoordenates2(input);
                                            break;
    ...
    public static int printAreaHome(Scanner input) {
        int option;
    ...
    public static int printPerimeterHome(Scanner input) {
        int option;
    ...
    public static void printOption3Home1() {
    ...
    public static int printOption2Home(Scanner input) {
        int option;
    ...
    public static int prinOption1Home(Scanner input) {
        int option;
    ...
    public static int printHome(Scanner input) {
        int option;
    ...
    public static void CalculateAPerimeter(Scanner input) {
        double px1;
        double px2;
        double px3;
        double py1;
    ...
    public static void CalculateAnArea3(Scanner input) {
        double px111;
        double px222;
        double px333;
        double px444;
    ...
    public static void CalculateAnArea2(Scanner input) {
        double px11;
        double px22;
        double px33;
        double px44;
    ...
    public static void CalculateAnArea(Scanner input) {
        double px1;
        double px2;
        double px3;
        double py1;
    ...
    public static void CalculateAPerimeter3(Scanner input) {
        double px111;
        double px222;
        double px333;
        double px444;
    ...
    public static void CalculateAPerimeter2(Scanner input) {
        double px11;
        double px22;
        double px33;
        double px44;
    ...
    public static void ConvertDecimalDegreesToUTMLongitude(Scanner input) {
        double longitud;
        double y;
    ...
    public static void ConvertGPSCoordenatesToDecimalCoordenates2(Scanner input) {
        double grados1;
        double minutos1;
        double segundos1;
        double dd1;
    ...
    public static void convertGPSCoordenatesToDecimalCoordenates(Scanner input) {
        double grados;
        double minutos;
        double segundos;
        double dd;
